...
/***/ function(module, exports, __webpack_require__) {
	...
	var authQuestion = __webpack_require__(36);
	...
	$('#close-questions').on('click', function () {
	  $('#show-questions').show();
	...
	$('#close-user-questions').on('click', function () {
	  $('#show-user-questions').show();
	  $('.question-index').empty();
	  $('#close-user-questions').hide();
	  $('#question-status').empty();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiQuestion = __webpack_require__(11);
	...
	var changingTurns = function changingTurns() {
	  if (currentPlayer === 'x') {
	    currentPlayer = 'o';
	...
	var selectSpace = function selectSpace(i) {
	  if (board[i] === '') {
	...
	var winHorizontal = function winHorizontal() {
	  var startPoint = 0;
	  var endPoint = size;
	  for (var j = 0; j < size; j++) {
	    var result = [];
	    for (var _i = startPoint; _i < endPoint; _i++) {
	      result.push(board[_i]);
	...
	var winVertical = function winVertical() {
	  var startPoint = 0;
	  var endPoint = size * (size - 1);
	  for (var j = 0; j < size; j++) {
	    var result = [];
	    for (var _i2 = startPoint; _i2 <= endPoint; _i2 += size) {
	      result.push(board[_i2]);
	      if (result.length === winSize) {
	        if (result.every(function (x) {
	          return x === 'x';
	        })) {
	...
	var shuffle = function shuffle(a) {
	  for (var _i3 = a.length; _i3; _i3--) {
	    var j = Math.floor(Math.random() * _i3);
	    var _ref = [a[j], a[_i3 - 1]];
	    a[_i3 - 1] = _ref[0];
	    a[j] = _ref[1];
	  }
	};

	var answerSet = function answerSet() {
	  $('.ans-cells').hide();
	  apiQuestion.getQuestion().then(function (response) {
	...
	var onAnswerClick = function onAnswerClick(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(id, playerOneStatus, playerTwoStatus, gameStatus) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showUserQuestions = function showUserQuestions() {
	  return $.ajax({
	    url: config.apiOrigin + '/questions/',
	    method: 'GET'
	  });
	...
	var editAnswer = function editAnswer(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/questions/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexQuestionsTemplate = __webpack_require__(13);
	var gameStore = __webpack_require__(10);
	var store = __webpack_require__(9);

	var indexSuccess = function indexSuccess(data) {
	  var index = indexQuestionsTemplate({
	...
	var showUserQuestionsSuccess = function showUserQuestionsSuccess() {
	  var size = gameStore.user.questions.length;
	  var count = 0;
	...
	var successCreateBoard = function successCreateBoard() {
	  $('h2').show();
	  $('.ans-cells').text("");
	  $('.answers').show();
	};

	var successCreateQuestion = function successCreateQuestion() {
	  $('#create-question-status').text("Question Created Successfully!");
	  $("input[type=text]").val("");
	};

	var failureCreateQuestion = function failureCreateQuestion() {
	...
	module.exports = {
	  ...
	  successCreateQuestion: successCreateQuestion,
	  failureCreateQuestion: failureCreateQuestion,
	  showUserQuestionsSuccess: showUserQuestionsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + "\">\n    <h5 class=\"problem\">Problem: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.problem : stack1), depth0))
	    + "</h5>\n    <h6 class=\"correct\">Answer: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.correct : stack1), depth0))
	    + "</h6>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.questions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function () {
	    delete store.user;
	    return store;
	  }).then(ui.successSignOut).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var successSignUp = function successSignUp() {
	  $('#modal-sign-up').hide();
	...
	var successChangePassword = function successChangePassword() {
	  $('#change-password-status').text("Change Password Successfully!");
	  $("input[type=password]").val("");
	};

	var failureChangePassword = function failureChangePassword() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateQuestion = function onCreateQuestion(event) {
	  ...
	  api.createQuestion(data).then(ui.successCreateQuestion).catch(ui.failureCreateQuestion);
	};

	var onShowQuestion = function onShowQuestion() {
	  api.showQuestions().then(ui.indexSuccess);
	};

	var onDeleteQuestion = function onDeleteQuestion(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.deleteQuestion(id).then(ui.deleteSuccess);
	};

	var onEditAnswer = function onEditAnswer(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  var answer = getFormFields(event.target);
	  if (answer.question.correct === "") {
	    $('#question-status').text("Invalid Answer");
	  } else {
	    api.editAnswer(id, answer).then(ui.editSuccess);
	  }
	};

	var onShowUserQuestions = function onShowUserQuestions() {
	  api.showUserQuestions().then(function (response) {
